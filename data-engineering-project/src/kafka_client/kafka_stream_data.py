...
def get_all_data(last_processed_timestamp: datetime) -> List[dict]:
    n_results = 0
    full_data = []
    while True:
        ...
        last_processed_timestamp = datetime.strftime(last_processed_timestamp, "%Y-%m-%d")
...
def create_kafka_producer():
    ...
    """
    try:
        producer = KafkaProducer(bootstrap_servers=["kafka:9092"])  #["broker:29092"])
