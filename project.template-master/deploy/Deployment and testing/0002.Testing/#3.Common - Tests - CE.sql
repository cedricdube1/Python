/************************************************************************
* Script     : #Common - Tests - CE.sql
* Created By : Hector Prakke
* Created On : 2021-09-23
* Execute On : As required.
* Execute As : N/A
* Execution  : As Required. Runs tests using @CE_MinID = 0
* Version    : 1.0
* Steps      : 1 > Player
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_Player @CE_MinID = 0;
  EXEC Surge_MLT.Process_Player @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_PlayerAcquisitionOffer @CE_MinID = 0;
  EXEC Surge_MLT.Process_PlayerAcquisitionOffer @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_RewardType @CE_MinID = 0;
  EXEC Surge_MLT.Process_RewardType @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_PlayerEligibility @CE_MinID = 0;
  EXEC Surge_MLT.Process_PlayerEligibility @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_PlayerOffer @CE_MinID = 0;
  EXEC Surge_MLT.Process_PlayerOffer @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_PlayerOfferExperience @CE_MinID = 0;
  EXEC Surge_MLT.Process_PlayerOfferExperience @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_PlayerOfferFreeGame @CE_MinID = 0;
  EXEC Surge_MLT.Process_PlayerOfferFreeGame @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_PlayerOfferStatusAccept @CE_MinID = 0;
  EXEC Surge_MLT.Process_PlayerOfferStatusAccept @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_PlayerOfferStatusReject @CE_MinID = 0;
  EXEC Surge_MLT.Process_PlayerOfferStatusReject @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_Deposit @CE_MinID = 0;
  EXEC Surge_MLT.Process_Deposit @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_PlayerOfferConversion @CE_MinID = 0;
  EXEC Surge_MLT.Process_PlayerOfferConversion @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_PlayerOfferIncentive @CE_MinID = 0;
  EXEC Surge_MLT.Process_PlayerOfferIncentive @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_Adjustment @CE_MinID = 0;
  EXEC Surge_MLT.Process_Adjustment @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_Tournament @CE_MinID = 0;
  EXEC Surge_MLT.Process_Tournament @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_TournamentPlayer @CE_MinID = 0;
  EXEC Surge_MLT.Process_TournamentPlayer @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_TournamentWager @CE_MinID = 0;
  EXEC Surge_MLT.Process_TournamentWager @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_PlayerOfferWager @CE_MinID = 0;
  EXEC Surge_MLT.Process_PlayerOfferWager @CE_MinID = 0;
...
IF @Stream = @TestStream OR @TestStream = 'All' BEGIN;
  ...
  -- EXECUTE --
  EXEC Surge_MIT.Process_TournamentInvitedPlayer @CE_MinID = 0;
  EXEC Surge_MLT.Process_TournamentInvitedPlayer @CE_MinID = 0;
