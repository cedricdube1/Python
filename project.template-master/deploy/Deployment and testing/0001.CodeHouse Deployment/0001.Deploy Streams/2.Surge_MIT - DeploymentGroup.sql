...
************************************************************************/
  ...
  DECLARE @MasterProviderExternalSystemID NVARCHAR(128) = 'Default',
          @ProviderExternalSystemID NVARCHAR(128) = 'MIT';
  ...
  SET @ExtractTableName = 'SURGE_tblRegistration_MIT';
  ...
  SET @ExtractTableName = 'SURGE_tblAcquisitionCompletedOffers_MIT';
  ...
  SET @HubStream = @ScriptStream;
  SET @ExtractTableName = 'PEX_lupRewardType_MIT';
  ...
  SET @HubStream = @ScriptStream;
  SET @ExtractTableName = 'SURGE_tblEligibility_MIT';
  ...
  SET @HubStream = @ScriptStream;
  SET @ExtractTableName = 'SURGE_tblOfferDetails_MIT';
  ...
  SET @ExtractTableName = 'SURGE_tblExperienceResult_MIT';
  ...
  SET @HubStream = 'PlayerOffer';
  SET @ExtractTableName = 'SURGE_tblFreeGamev3_MIT';
  ...
  SET @HubStream = 'PlayerOffer';
  SET @ExtractTableName = 'SURGE_tblOptInv3_MIT';
  ...
  SET @HubStream = 'PlayerOffer';
  SET @ExtractTableName = 'SURGE_tblOptInCancel_MIT';
  ...
  SET @HubStream = @ScriptStream;
  SET @ExtractTableName = 'SURGE_tblDeposit_MIT';
  ...
  SET @HubStream = 'PlayerOffer';
  SET @ExtractTableName = 'SURGE_tblConversionv3_MIT';
  ...
  SET @HubStream = @ScriptStream;
  SET @ExtractTableName = 'SURGE_tblPlayerIncentive_MIT';
  ...
  SET @HubStream = @ScriptStream;
  SET @ExtractTableName = 'PEX_tblBalanceUpdate_MIT';
  ...
  SET @HubStream = @ScriptStream;
  SET @ExtractTableName = 'SURGE_tblTournamentSetup_MIT';
  ...
  SET @HubStream = @ScriptStream;
  SET @ExtractTableName = 'SURGE_tblTournamentReport_MIT';
  ...
  SET @HubStream = @ScriptStream;
  SET @ExtractTableName = 'SURGE_tblTournamentWager_MIT';
  ...
  SET @HubStream = 'PlayerOffer';
  SET @ExtractTableName = 'SURGE_tblTriggeringWager_MIT';
  ...
  SET @ExtractTableName = 'SURGE_tblTournamentEligibleUser_MIT';
  ...
  SET @HubStream = @ScriptStream;
  SET @ExtractTableName = 'SURGE_tblPlayerBonusCredit_MIT';
  ...
  SET @HubStream = @ScriptStream;
  SET @ExtractTableName = 'SURGE_tblTriggerConditionsMet_MIT';
  SET @CDOtrackedColumn = 'ID';
