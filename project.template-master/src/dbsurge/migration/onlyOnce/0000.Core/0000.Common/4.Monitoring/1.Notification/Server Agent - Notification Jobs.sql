/***********************************************************************************************************************************
* Script      : SQL Server Agent - Notification Jobs.sql
...
DECLARE @ProcessJobSchema NVARCHAR(128) = N'Notification';
DECLARE @ProcessJobProcedure NVARCHAR(128) = N'Process_Alerting';
