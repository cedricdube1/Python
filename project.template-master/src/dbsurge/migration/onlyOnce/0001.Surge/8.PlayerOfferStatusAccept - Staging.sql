/************************************************************************
* Script     : 8.PlayerOfferStatusAccept - Staging.sql
...
*            :     3.1 > Extract_PlayerOfferStatusAccept (handled by Common, no need to specify here)
*            :     3.2 > Stage_PlayerOfferStatusAccept
*            :     3.3 > Load_PlayerOfferStatusAccept
*            :     3.4 > Process_PlayerOfferStatusAccept
*            :   4 > Config
*            :     4.1 > Setup: Process
*            : 3 > Calling Scripts
*            :   3.1 > GetDeployment
...
------------------
-- Stage_PlayerOfferStatusAccept
------------------
DECLARE @Layer VARCHAR(50) = 'Staging',
        @Stream VARCHAR(50) = 'PlayerOfferStatusAccept',
        @StreamVariant VARCHAR(50) = 'Surge',
        @CodeObjectName NVARCHAR(128) = 'Stage_PlayerOfferStatusAccept',
...
'Stage Surge PlayerOfferStatusAccept from Delta keys.';
    ...
    BEGIN TRY
      ...
      INSERT INTO #Stage_{StreamVariant}_{Stream} (
        ...
        [MaxTier]
               ...
               @ProcessLogID,
               [OptInv3ID],
               COALESCE([ApplicationDate], [InsertedDateTime], @NowTime),
               @SourceSystemID,
               @OriginSystemID,
               -- KEYS --
               ...
               -- Dates --
               COALESCE([ApplicationDate], [InsertedDateTime], @NowTime),
               COALESCE([EndDateTime], ''9999-12-31 23:59:59'', @NowTime),
               -- Others --
         ...
         INNER JOIN [{ExtractDatabase}].[{ExtractSchema}].[{ExtractTableName}] [STBL]
            ON [CT].[PayloadID] = [STBL].[OptInv3ID]
...
GO
------------------
-- Load_PlayerOfferStatusAccept
------------------
DECLARE @Layer VARCHAR(50) = 'Staging',
        @Stream VARCHAR(50) = 'PlayerOfferStatusAccept',
        @StreamVariant VARCHAR(50) = 'Surge',
        @CodeObjectName NVARCHAR(128) = 'Load_PlayerOfferStatusAccept',
        @VersionType CHAR(5) = 'Major',
        @ObjectType VARCHAR(50) = 'Procedure',
        @CodeType VARCHAR(50) = 'Task',
        @Author NVARCHAR(128) = 'Cedric Dube',
    ...
    BEGIN TRANSACTION;
      ...
      INSERT INTO [dbo].[Status] (
        ...
        [StatusName]
               ...
               PLD.[StatusName]
         FROM #Stage_Surge_PlayerOfferStatusAccept PLD
...
GO
------------------
-- Process_PlayerOfferStatusAccept
------------------
DECLARE @Layer VARCHAR(50) = 'Staging',
        @Stream VARCHAR(50) = 'PlayerOfferStatusAccept',
        @StreamVariant VARCHAR(50) = 'Surge',
        @CodeObjectName NVARCHAR(128) = 'Process_PlayerOfferStatusAccept',
        @VersionType CHAR(5) = 'Major',
        @ObjectType VARCHAR(50) = 'Procedure',
  ...
  IF @StreamVariantTag IS NULL
    ...
    INSERT INTO @GenerateList (
      ...
      [ObjectLayer]
             ...
             (4,  ''PlayerOfferStatusAccept'', ''Surge'', ''Procedure'', ''Task'', ''Stage_PlayerOfferStatusAccept'', @Layer),
             (5, ''PlayerOfferStatusAccept'', ''Surge'', ''Procedure'', ''Task'', ''Load_PlayerOfferStatusAccept'', @Layer),
             (6, ''PlayerOfferStatusAccept'', ''Surge'', ''Procedure'', ''Process'', ''Process_PlayerOfferStatusAccept'', @Layer),
             (7, ''PlayerOfferStatusAccept'', ''Surge'', ''Script'',    ''Process'', ''Setup'', @Layer),
